    ...
    <div class="row">
      ...
      <div class="media d-flex  align-items-center">
        ...
        <div class="media-body" style="padding: 4%;">
          ...
          <p class="font-weight-normal text-muted mb-0">مشرف</p>
        </div>
      </div>
    </div>
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link link1" aria-current="page" href={{ route('new_employee',['type'=>'Enterer']) }}>
              <i class="fas fa-plus"></i>
              <span> اضافة موظف</span> 
            </a>
          </li> <li class="nav-item">
            <a class="nav-link link1" aria-current="page" href={{ route('new_scout') }}>
              <i class="fas fa-plus"></i>
              <span> اضافة كشاف</span> 
            </a>
          </li> <li class="nav-item">
            <a class="nav-link link1" aria-current="page" href={{route('display_employees')}}>
              <i class="fas fa-eye"></i>
              <span> عرض الموظفين</span> 
            </a>
          </li> <li class="nav-item">
            <a class="nav-link link1" aria-current="page" href={{route('contol_health_status',['flag'=>0])}}>
              <i class="fas fa-heartbeat"></i>
              <span>تعديل الوضع الصحي </span> 
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link link1" aria-current="page" href={{ route('Show_Admin_Info') }}>
              <i class="fas fa-user-circle"></i>
              <span>معلوماتي</span> 
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link link1" aria-current="page" href={{ route('Admin_logout') }} style="color: red">
